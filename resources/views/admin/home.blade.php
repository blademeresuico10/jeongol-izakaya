    ...
    <!-- Add this script section to your blade template, replacing the existing JavaScript -->
<script>
    const state = {
        salesData: {
            weekly: { labels: [], data: [] },
    ...
    async function refreshDashboard() {
        try {
            ...
            // Revenue - ensure we're updating the correct element
    ...
    async function refreshSalesChart() {
        try {
            ...
            // Update state with new sales data
            if (data.weekly) {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        setInterval(refreshDashboard, 30000); // Refresh every 30 seconds instead of 5
        setInterval(refreshSalesChart, 60000); // Refresh chart every minute
