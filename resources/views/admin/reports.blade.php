...
<div id="content-wrapper" class="flex flex-col min-h-screen">
    <div id="content" class="flex-1">
        ...
        <div class="p-6 space-y-6">
                ...
                <div class="flex flex-wrap gap-4 items-end">
                    ...
                    <div class="flex">
                        <button type="button" onclick="exportToExcel()"
                            class="bg-blue-600 text-white px-5 py-3 rounded-lg mt-4">
            ...
            <div id="reportContent" class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <table class="w-full border border-gray-200">
                    ...
                    <tbody>
                        ...
                        <tr class="border-t">
                            ...
                            <td class="px-4 py-2 text-right">₱{{ number_format($s->discount_amount, 2) }}</td>
                            <td class="px-4 py-2 text-right">₱{{ number_format($s->total_amount, 2) }}</td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="7" class="px-4 py-2 text-center text-gray-500">No sales data</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
