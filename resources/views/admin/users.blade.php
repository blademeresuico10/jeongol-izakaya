        ...
        @if($user->profile_picture)
            <img src="{{ url('file-serve/' . $user->profile_picture) }}" 
                alt="Profile Picture" 
        ...
        @endif
            ...
            <div class="modal-dialog" role="document">
                <form action="{{ route('storeUser') }}" method="POST" id="addUserForm" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="contact_number" class="form-control" required pattern="[0-9]{10,11}" title="Please enter a valid phone number (10-11 digits)">
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="username" class="form-control" required minlength="3" pattern="[a-zA-Z0-9_]+" title="Username must contain only letters, numbers, and underscores">
                                <div class="invalid-feedback"></div>
                            </div>
