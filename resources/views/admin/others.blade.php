                                ...
                                <tbody>
                                    @forelse ($stock_order as $order)
                                        <tr>
                                            ...
                                            <td>
                                                {{ number_format($order->requested_quantity, 2) }}
                                            ...
                                            <td class="text-center">
                                                <button class="btn btn-xs btn-primary p-1 edit-order-stock"
                                                    ...
                                                    data-quantity="{{ $order->requested_quantity }}"
                        ...
                        <form action="{{ route('admin.stock_orders.store') }}" method="POST">
                            ...
                            <div class="modal-body p-3">
                                ...
                                <div class="form-group mb-0">
                                    <label class="small font-weight-bold">Requested Quantity (<span
            ...
            <form id="modifyStockLevelForm" method="POST">
                ...
                <div class="modal-body p-3">
                    <div class="form-group">
                        ...
                        <input type="number" name="low_stock" id="lowStockInput" class="form-control form-control-sm"
                            min="0" step="0.01" required>
                    </div>
                    <div class="form-group mb-0">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Edit Stock Level - THIS IS THE FIX
        document.addEventListener('click', function (e) {
        ...
        document.addEventListener('click', function (e) {
            if (e.target.closest('.edit-order-stock')) {
                ...
                document.getElementById('orderUnit').textContent = displayUnit;
