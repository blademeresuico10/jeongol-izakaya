            ...
            @endphp
              <tr>
                ...
                <input type="number" name="stocks[{{ $item->id }}]" value="{{ $qty }}" min="0" max="100"
                  class="form-control text-center stock-input" style="width: 80px; margin: 0 auto;" readonly
                  required>
                </td>
                <td>
                ...
                <td>
                <i class="bi bi-pencil-fill text-primary edit-stock" style="cursor: pointer;"
                  data-id="{{ $item->id }}"></i>
                </td>
              </tr>
        @endforeach
