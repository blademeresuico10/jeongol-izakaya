  ...
  <div class="flex gap-6 max-w-9xl mx-auto items-start">
    ...
    <div class="bg-white border rounded-xl shadow-lg w-1/2 flex flex-col">
      ...
      <div class="border-b bg-gray-100 rounded-t-xl flex">
        ...
        <button 
          wire:click="$set('activeTab', 'served')" 
              ...
              <div class="border rounded-lg p-3 max-h-64 overflow-y-auto space-y-2">
                @foreach($unlimitedIngredients as $ingredient)
                  <label class="flex items-center p-2 hover:bg-gray-50 rounded cursor-pointer">
                    <input type="checkbox" wire:model="selectedIngredients.{{ $ingredient->id }}.selected" value="1"
                    ...
                    <input type="number" wire:model="selectedIngredients.{{ $ingredient->id }}.quantity"
                      min="50" step="50" placeholder="Grams"
                      @if(!isset($selectedIngredients[$ingredient->id]['selected'])) disabled @endif
