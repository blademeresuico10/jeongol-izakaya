    ...
    Route::get('/reservations/unavailable-times', [CustomerController::class, 'getUnavailableTimes']);
    ...
    Route::middleware('guest')->group(function () {
        ...
        Route::post('/login/admin/verify-code', [LoginController::class, 'verifyResetCode'])->name('admin.password.verify');
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::post('/cashier/update-advance/{id}', [CashierController::class, 'updateAdvance'])->name('cashier.updateAdvance');
    });
